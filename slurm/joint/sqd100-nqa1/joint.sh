...
#SBATCH --output=nqa-001-sratio0.1-bsize10-%A.out
#SBATCH --error=nqa-001-sratio0.1-bsize10-%A.err
#SBATCH --gres=gpu:1
...
# Evaluate on SQuAD
python -m allennlp.run evaluate output/joint_nqa_001_0.1/model.tar.gz --evaluation-data-file "data/squad/dev-v1.1.json"

# Evaluate on NewsQA
python -m allennlp.run evaluate output/joint_nqa_001_0.1/model.tar.gz --evaluation-data-file "data/NewsQA/test-v1.1.json"
