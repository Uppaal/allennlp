...
#SBATCH --output=batch10_bidaf-pytorch-%A.out
#SBATCH --error=batch10_bidaf-pytorch-%A.err
#SBATCH --gres=gpu:1
...
python -m allennlp.run train training_config/bidaf10.json -s output_path_newsqa_batch10
