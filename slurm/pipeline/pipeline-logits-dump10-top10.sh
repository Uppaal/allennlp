...
#
#SBATCH --mem=50000
#SBATCH --job-name=ld10t10
#SBATCH --partition=m40-long
#SBATCH --output=logits-dump10-top10-i3-%A.out
#SBATCH --error=logits-dump10-top10-i3-%A.err
#SBATCH --gres=gpu:1
...
rm output_active/$dir/iteration_$i/*.th
