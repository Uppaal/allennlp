...
#
#SBATCH --mem=50000
#SBATCH --job-name=cld1t1
#SBATCH --partition=m40-long
#SBATCH --output=certain-logits-dump1-top1-i2-%A.out
#SBATCH --error=certain-logits-dump1-top1-i2-%A.err
#SBATCH --gres=gpu:1
