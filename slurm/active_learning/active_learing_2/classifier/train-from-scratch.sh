...
#
#SBATCH --mem=50000
#SBATCH --job-name=a-c10-s
#SBATCH --partition=titanx-long
#SBATCH --output=classifier-top10-scratch-%A.out
#SBATCH --error=classifier-top10-scratch-%A.err
#SBATCH --gres=gpu:1
...
# Train
python -m allennlp.run train training_config/bidaf_active.json -s output/active_classifier_top_10_scratch

# Evaluate on SQuAD
python -m allennlp.run evaluate output/active_classifier_top_10_scratch/model.tar.gz --evaluation-data-file "data/squad/dev-v1.1.json"

# Evaluate on NewsQA
python -m allennlp.run evaluate output/active_classifier_top_10_scratch/model.tar.gz --evaluation-data-file "data/NewsQA/test-v1.1.json"
