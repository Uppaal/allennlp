...
#SBATCH --output=batch15_bidaf-pytorch-%A.out
#SBATCH --error=batch15_bidaf-pytorch-%A.err
#SBATCH --gres=gpu:1
...
python -m allennlp.run train training_config/bidaf15.json -s output_path_newsqa_batch15
