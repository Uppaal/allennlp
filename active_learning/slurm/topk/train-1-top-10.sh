...
python make_data.py --percent 1 --gpu 1 --k 10 --source_logits_file "data/train-logits.p" --source_file "data/newsqa/train_dump.json" --target_file "data/newsqa/logits_top_train_dump_1_top_10.json"
