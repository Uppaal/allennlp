...
#SBATCH --output=dev10-al-%A.out
#SBATCH --error=dev10-al-%A.err
#SBATCH --gres=gpu:1
...
python make_data.py --percent 10 --gpu 1 --source_logits_file "data/dev-logits.p" --source_file "data/newsqa/dev_dump.json" --target_file "data/newsqa/top_dev_dump_10.json"
