...
#SBATCH --output=s_train-2-al-%A.out
#SBATCH --error=s_train-2-al-%A.err
#SBATCH --gres=gpu:1
...
python make_data.py --percent 2 --gpu 1 --source_logits_file "data/train-logits.p" --source_file "data/newsqa/train_dump.json" --target_file "data/newsqa/softm_top_train_dump_2.json"
