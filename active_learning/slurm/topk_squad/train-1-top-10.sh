...
#SBATCH --output=l-1-10-al-%A.out
#SBATCH --error=l-1-10-al-%A.err
#SBATCH --gres=gpu:1
...
python process_logits.py --percent 1 --gpu 1 --k 10 --source_logits_file "data/train-logits.p" --source_file "data/squad/train-v1.1.json" --target_file "data/al_squad/logits_top_train_dump_1_top_10.json"
