...
#SBATCH --output=l-10-10-al-%A.out
#SBATCH --error=l-10-10-al-%A.err
#SBATCH --gres=gpu:1
...
python process_logits.py --percent 10 --gpu 1 --k 10 --source_logits_file "data/train-logits.p" --source_file "data/squad/train-v1.1.json" --target_file "data/al_squad/logtis_top_train_dump_10_top_10.json"
