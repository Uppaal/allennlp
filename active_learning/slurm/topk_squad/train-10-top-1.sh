...
python process_logits.py --percent 10 --gpu 1 --k 1 --source_logits_file "data/train-logits.p" --source_file "data/squad/train-v1.1.json" --target_file "data/al_squad/logits_top_train_dump_10_top_1.json"
