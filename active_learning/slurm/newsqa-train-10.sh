...
#SBATCH --output=ntrain-10-al-%A.out
#SBATCH --error=ntrain-10-al-%A.err
#SBATCH --gres=gpu:1
...
python process_logits.py --percent 10 --gpu 1 --source_logits_file "data/train-logits.p" --source_file "data/newsqa/train_dump.json" --target_file "data/newsqa/soft_train_dump_10.json"
