...
python make_data.py --percent 1 --gpu 1 --source_logits_file "data/dev-logits.p" --source_file "data/newsqa/dev_dump.json" --target_file "data/newsqa/top_dev_dump_1.json"
